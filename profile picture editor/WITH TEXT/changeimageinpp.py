...
p = fitz.Point(555, 44)  # bottom-left of the first character
...
while True:
    ...
    if user_input.isdigit():
        ...
        if 0 <= number < 100:
            # Format the number to '00' format
...
for page_index in range(len(doc)):  # Iterate over PDF pages
    ...
    # Calculate the center coordinates for the image placement
    center_x = (page_width - new_width) / 2
    center_y = (page_height - new_height) / 2

    # Insert the resized image at the center of the page
