...
trade_options.extend(['ELECTRICIAN', 'PLUMBING', 'TILING', 'WELDING', 'BLACKSMITH', 'CARPENTRY', 'HVAC', 'CAR BODY REPAIR',
                      'CONSTRUCTION AND BUILDING', 'PAINTING', 'PLASTERER','SHUTTERING CARPENTER', 'AUTOMOTIVE ELECTRICIAN', 'AUTOMOTIVE MECHANICS'])

# Define the list of files to copy with name and trade prefix
files_to_prefix = [
    'PP.pdf',  # Example: 'PP.pdf' file
    'Profile.docx'  # Example: 'Profile.docx' file
]

# Define the list of files to copy without name and trade prefix
files_no_prefix = [
    'changeimageinpp.py'  # Example: 'Resume.pdf' file
]
